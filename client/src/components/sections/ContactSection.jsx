...
export default function ContactSection() {
    return (
        <section id="contact" className="py-32 px-6 bg-charcoal relative">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col items-center justify-center mt-16 space-y-12">
                    <TextRoll href="mailto:bijalwanakshat@gmail.com" className="text-4xl md:text-7xl font-sans font-light lowercase text-white hover:text-gold-accent transition-colors leading-tight" text="bijalwanakshat@gmail.com" />
